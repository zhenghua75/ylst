...
class game
{
	...
	public function gameList($catid, $what_game)
	{
		$url = $this->serverUrl . "index.php?m=Game&c=api&a=gameList&catid=" . $catid . "&what_game=" . $what_game . "&domain=" . $this->topdomain;
		$rt = $this->api_notice_increment($url);
		return json_decode($rt, 1);
	}
	...
	public function gameSelfSet($uid, $gameid, $userGameid, $gameortest, $key, $data, $delete)
	{
	...
	public function gameSet($uid, $gameid, $userGameid, $key, $data, $gameortest)
	{
		if ($data) {
