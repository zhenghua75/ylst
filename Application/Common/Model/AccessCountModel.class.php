...
class AccessCountModel extends Model {
	...
	public function setCount($params) {
		...
		$params['module'] = strtolower(MODULE_NAME);
		$params['controller'] = strtolower(CONTROLLER_NAME);
	...
	private function _tokenUser($data) {
		...
		if (1 == count($tokens) && array_key_exists('alltoken', $tokens) && 'alltoken' == $tokens['alltoken']) {
