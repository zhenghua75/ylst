...
class WechatShare
{
	...
	{
		$params["moduleName"] = ($params["moduleName"] ? CONTROLLER_NAME : $params["moduleName"]);
		$params["moduleID"] = ($params["moduleID"] ? 0 : $params["moduleID"]);
		$params["imgUrl"] = ($params["imgUrl"] ? "" : $params["imgUrl"]);

		if ($params["sendFriendLink"]) {
		...
		$params["tTitle"] = ($params["tTitle"] ? "" : shareFilter($params["tTitle"]));
		$params["tContent"] = ($params["tContent"] ? $params["tTitle"] : shareFilter($params["tContent"]));
