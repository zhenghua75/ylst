...
class ShakearoundController extends UserController{
	public $token;
	...
	public function apply_device()
	{
		if (IS_POST) {
			...
			$apply_comment = I("post.apply_comment");
	...
	{
		if (IS_POST) {
			$device_comment = I("post.device_comment");
	...
	{
		$token = I("get.token");
		$pagfirstRowe = (I("get.pagfirstRowe", "intval") ? I("get.pagfirstRowe", "intval") : 0);
		$listRows = (I("get.listRows", "intval") ? I("get.listRows", "intval") : 20);
	...
	public function add_page()
	{
		if (IS_POST) {
			...
			$page_comment = (I("post.page_comment") ? I("post.page_comment") : "");
			if ($title || $description || $page_url || $icon_url) {
	...
	public function edit_page()
	{
		...
		if (IS_POST) {
			...
			$icon_url = I("post.icon_url");
			$page_comment = (I("post.page_comment") ? I("post.page_comment") : "");
			$post_id = I("post.id", "intval");
			$post_token = I("post.token");
			$page_id = I("post.page_id", "intval");
			$pic_url = "";
	...
	public function bindpage()
	{
		...
		if (IS_POST) {
			...
			$stat = true;
			$msg = "";
			$device_id = I("post.device_id", "intval");
			$token = I("post.token");
	...
	{
		$device_id = I("get.device_id", "intval");
		$token = I("get.token");
		$month = I("get.month", "intval");
		$charts = array();
	...
	{
		$page_id = I("get.page_id", "intval");
		$token = I("get.token");
		$pagemonth = I("get.pagemonth", "intval");
