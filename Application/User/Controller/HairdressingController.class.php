...
class HairdressingController extends UserController{
        ...
        if(IS_POST){
            ...
            if(!$check){
                ...
                if(!$t_hairdressing->create()){
                    ...
                    $hid = filter_var(I('post.hid'),FILTER_VALIDATE_INT);
    ...
    public function setmeal_add(){
        ...
        $iid = filter_var(I('get.iid'),FILTER_VALIDATE_INT);
        ...
        if(IS_POST){
            ...
            if(!$check){
                ...
                if(!$t_hairdressing_i->create()){
                    ...
                    $iid = filter_var(I('post.iid'),FILTER_VALIDATE_INT);
                    $type = filter_var(I('post.type'),FILTER_SANITIZE_STRING);
