...
class CollectwordController extends UserController{
	...
	public function set()
	{
		...
		if (IS_POST) {
			...
			if ($Sentiment["id"]) {
				...
				$this->handleKeyword($id, "Collectword", I("post.keyword"));
	...
	public function rank()
	{
		...
		$order = ($order ? "word_count DESC, share_num DESC,addtime ASC" : $order);
