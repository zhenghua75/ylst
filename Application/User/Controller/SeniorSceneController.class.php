...
class SeniorSceneController extends UserController
{
		...
		if (IS_POST) {
			if (D("Senior_scene")->create()) {
				if ($seniorScene_info) {
					...
					$this->handleKeyword(I("post.id", "intval"), "SeniorScene", I("post.keyword"));
					...
					$this->handleKeyword($id, "SeniorScene", I("post.keyword"));
