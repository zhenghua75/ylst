...
class ForumController extends UserController{
	...
	public function set(){
		...
		$token = $this->token;
		$data['forumname'] = I('post.forumname');
		$data['logo'] = I('post.logo');
		$data['intro'] = I('post.intro');
		$data['picurl'] = I('post.picurl');
		$data['bgurl'] = I('post.bgurl');
		$data['ischeck'] = I('post.ischeck','intval');
		$data['comcheck'] = I('post.comcheck','intval');
		$data['isopen'] = I('post.isopen','intval');
		$data['token'] = $token;
