...
class WallController extends UserController{
	...
	public function _initialize() {
		...
		$info = $this->wall_model->where(array('token'=>$this->token,'id'=>I('get.id',0,'intval')))->find();
...
/*信息审核*/
	...
	function is_check(){
		$result = array();
		$wallid = I('post.wallid');
		$mid 	= I('post.mid',0,'intval');
		$sceneid= I('post.sceneid',0,'intval');
