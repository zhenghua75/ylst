...
class ShakeLotteryController extends UserController{
	...
	{
		if (IS_POST) {
			$isaccept = I("post.isaccept", "intval");
			$id = I("post.id", "intval");
	...
	public function record_details()
	{
		...
		if (($shakelottery_hbrecord["mch_billno"] == "") || $shakelottery_hbrecord) {
			$this->error("操作失败");
		}
