...
class AuthAction extends BaseController {	
	...
	public $_accessListAction = array(
				...
				'voteimg', 'custom', 'card', 'game', 'live', 'research', 'forum', 'autumn', 'helping'
			);
	...
	private $_allowModel = array(
		'select' => array(
			...
			'CashierActivity', 'BargainKanuser', 'SeckillBaseShop',	'CrowdfundingOrder', 'UnitaryLucknum', 'CutpriceOrder',
		),
		'update' => array(
