...
class UseController extends BackController{
    ...
    public function index(){
        if (I('get.token') == 'alltoken') {
            $this->assign('pc','1');
        }
        if (I('get.token')) {
            if (I('get.is_what') == 'public_hao') {
                $group = 'token';
        ...
        $this->assign('wxuser',I('get.wxname'));
