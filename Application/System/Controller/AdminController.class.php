...
class AdminController extends Controller{
    ...
    public function insert(){
        ...
        //if (C('server_topdomain')){
            ...
            if(!$verify->check(I('post.code'),'verifyadminlogin')){
        ...
        $authInfo = \Common\Api\RBAC::authenticate($map,'User');
        //使用用户名、密码和状态的方式进行认证&& C('server_topdomain')
        ...
        if((false == $authInfo)) {
            ...
            // 缓存访问权限
            \Common\Api\RBAC::saveAccessList();
