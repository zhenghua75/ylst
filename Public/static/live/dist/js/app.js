define("dist/js/app", ["./zepto","./touch","./global","./page","./media","./image","./event","./sileFn","./map","./ylMap","./form","./plugins","./ylMusic","./fx","./weixin","./Lottery", "./video"], 
    ...
    var e = t("./zepto"),
        ...
        i = {
            lazy_img: function () {
                ...
                t.each(function () {
                    var t = e(this);
                    if (t.is("img")) t.attr("src", "__PUBLIC__/static/live/images/loading_large.gif");
                    else {
                        ...
                        t.attr({
                            ...
                            "background-image": "url(__PUBLIC__/static/live/images/loading_large.gif)",
        ...
        t.fn.ylmap = function (e) {
            ...
            return this.each(function () {
                ...
                var a, o, r, s, l = t(this),
                    ...
                    m = null,
                    v = null,
                    x = t('<div id="l-map" class="BDMap"></div>');
                    y = t('<input type="hidden" id="longitude" value="'+h+'">');
                    z = t('<input type="hidden" id="latitude" value="'+u+'">');
                    ...
                    l.append(t('<p class="map_close_btn">退出</p>')), l.length > 0 && l.height(), f && l.find(".map_close_btn").css("display", "block"), t("#transit_result").length > 0 && "" != t("#transit_result").html() && t(".transitBtn").removeClass("hide");
                var _ = function () {
        ...
        r = {
            init: function () {
                e("#coffee_flow").coffee({
                    steams: ["<img src='__PUBLIC__/static/live/images/audio_widget_01@2x.png' />", "<img src='__PUBLIC__/static/live/images/audio_widget_01@2x.png' />"],
                    steamHeight: 100,
                    steamWidth: 44
                }), 
                o.media_init(),
                ...
                if (1 == n) {
                    var a = e("#j-mengban")[0],
                        s = "__PUBLIC__/static/live/images/page_01_bg@2x.jpg",
                        l = e("#r-cover").val(),
                        c = "image",
                        u = 640,
                        h = e(window).height(),
