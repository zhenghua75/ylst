    ...
    function(e, t) {
        ...
        function i() {
            if (!Ot.is("wechat") && !(pt[lt] && pt[lt][4] || "no" === (W("toolbar") || "").toLowerCase())) {
                ...
                if (!e) {
                    ...
                    y(t.join("")), e = Z.createElement("div"), e.id = Gt.slice(1), e.innerHTML = ['<div id="hw-bar" class="hw-bar">', "<header>", "<h4>火舞游戏，为未来而生</h4>", '<div class="hw-clip">', '<div class="hw-clip-btn"><img src="' + ht + '/images/home/logo200.png"></div>', "</div>", "</header>", "<nav>", "<ul>", Ot.env.app ? "" : '<li><a href="#" class="hw-btn-app" data-action="app">安装<strong>火舞APP</strong>，体验精品游戏</a></li>', Ot.env.wechat ? '<li><a href="#" data-action="share">挑战好友</a></li>' : "", '<li><a href="#" data-action="more">更多游戏</a></li>', '<li><a href="#" class="hw-btn-resume" data-action="close">返回游戏</a></li>', "</ul>", "</nav>", "</div>"].join(" "), e.addEventListener(nt, R), e.addEventListener(it, R), A("header", e).addEventListener(nt, function() {
                        B("toolbar", "click", "toggle"), r()
                    }), A("nav", e).addEventListener(ot, function(e) {
                        var t = e.target.getAttribute("data-action");
                        t && (e.preventDefault(), B("toolbar", "click", t)), "app" === t ? Ot.download() : "share" === t ? (Ot.share(), r(!1)) : "follow" === t ? Ot.follow() : "more" === t ? Ot.more() : "close" === t && r(!1)
                    }), A("body").appendChild(e), Ht.toolbarExpand = !1
                }
                return e
            }
        }
        ...
        function h() {
            ...
            if (!e) {
                ...
                e.innerHTML = Ht.channelLogo ? [Ht.channelAloneLogo ? '<div class="inner alone"><img src="' + ht + "/images/home/loading_" + lt + '.png"></div>' : "", '<div class="inner"' + (6 > o || o > 20 ? ' style="background: #2c2a2a;"' : "") + ">", '<img src="' + ht + '/images/home/logo_wr_220x100_black.png" height="80">', '<img src="' + ht + "/images/home/logo_" + lt + '.png" height="80">', t ? "<p>" + (pt[lt][3] ? "“<strong>" + pt[lt][0] + "</strong>”" : "<strong>小猪</strong> &bull; <strong>" + t + "</strong>") + " 原创出品</p><p>授权" + (pt[lt][3] ? "<strong>小猪</strong>" : "“<strong>" + pt[lt][0] + "</strong>”") + (pt[lt][5] || "联合发布") + "</p><p>转载请经过授权，侵权必究</p>" : "<p>" + (pt[lt][3] ? "“<strong>" + pt[lt][0] + "</strong>”出品, 授权<strong>小猪</strong>" + (pt[lt][5] || "联合发布") : "<strong>小猪</strong>出品, 授权“<strong>" + pt[lt][0] + "</strong>”" + (pt[lt][5] || "联合发布")) + "</p>", '<p class="hw_info">游戏载入中...</p>', '<div class="progress" style="display:none;"><div class="bar">0%</div></div>', "</div>"].join("") : ['<div class="inner"' + (6 > o || o > 20 ? ' style="background: #2c2a2a;"' : "") + ">", '<img src="' + ht + '/images/home/logo_wr_220x100_black.png" height="80">', t ? "<p><strong>小猪游戏</strong> &bull; <strong>" + t + "</strong> 原创出品</p><p>转载请经过授权，侵权必究</p>" : "<p>小猪游戏 &bull; 为未来而生</p>", '<p class="hw_info">游戏载入中...</p>', '<div class="progress" style="display:none;"><div class="bar">0%</div></div>', "</div>"].join(""), e.addEventListener(nt, R), e.addEventListener(it, R), A("body").appendChild(e)
            }
            return e
        }
        function g(e) {
        ...
        Ot.ready(function() {
            ...
            var b = Ht.share,
                w = {
                    ...
                    link: bt,
                    query: "",
                    title: b.title || Z.title || "小猪游戏",
                    desc: b.desc || Z.title || "小猪游戏"
                };
